...
// 以下组件未裁剪进 @vunk-plus/ant，其 locale 类型以宽松结构替代
type PaginationLocale = Record<string, any>;
type TableLocale = Record<string, any>;
type TransferLocale = Record<string, any>;
type TourLocale = Record<string, any>;
type DatePickerLocale = Record<string, any>;
